...
/**
 * This is the model class for table "Kategori_Dokumentasi".
 *
 * The followings are the available columns in table 'Kategori_Dokumentasi':
 * @property integer $id_dokumentasi
 * @property integer $id_kategori
 */
class KategoriDokumentasi extends CActiveRecord
{
	/**
	 ...
	 * @return KategoriDokumentasi the static model class
	 */
